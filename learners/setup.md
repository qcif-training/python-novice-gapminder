...
Note that on Windows, if extracted in the default location, the data will be inside
the folders **python-novice-gapmidner-data/data**, rather than just inside a **data** folder.
...
Note that installing Anaconda and using the Anaconda prompt can be quite involved and difficult
for learners who have never used a terminal before. You may need to set aside some time to guide
participants through installing and using Anaconda.
Alternatively, installing and using Spyder directly can be the much simpler option.
:::::::::::::::::::::::::::::::::::::::::::
...
<!-- 
Maintainer notes:
The Carpentries Workbench does not like nested list items in group-tabs. Bummer.

Entering a standard nested list with a space for parsing will cause them to appear as basic list items.
Entering a nested list row with a tab at the start will hide all list items before the tab.
-->

::::::::::::::::::::::::::::::::::: group-tab
### Windows
To install Anaconda Distribution on Windows follow these steps:
...
###  MacOS
To install Anaconda Distribution on MacOS follow these steps:
...
::::::::::::::::::::: instructor
### Conda environments
Note that this is included for more advanced users only, or to demonstrate how participants
can install new packages for Python.
...
[spyderinstall]: https://docs.spyder-ide.org/current/installation.html
